...
**Last updated:** Phase 9 in progress (Frontend Foundation). M0–M5 complete.
...
| 9 | In progress | Next.js frontend — M0–M5 complete (app shell + settings + indexing) |
...
**Next milestone:** M6 — Files browser.
