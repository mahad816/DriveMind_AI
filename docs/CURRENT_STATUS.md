...
**Last updated:** Phase 9 in progress (Frontend Foundation). M0–M4 complete.
...
| 9 | In progress | Next.js frontend — M0–M4 complete (app shell + settings) |
...
**Next milestone:** M5 — Indexing dashboard with pipeline controls.
